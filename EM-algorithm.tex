...
\[\log(\psi_{kl}(Y))=\log\left(\frac{1}{\sqrt{1-\hat{\rho_{kl}}^2}}\right)+\frac{\hat{\rho_{kl}}}{1-\hat{\rho_{kl}}^2}\cdot y_{ik}y_{il} - 
\frac{\hat{\rho_{kl}}^2}{1-\hat{\rho_{kl}}^2}\cdot \frac{y_{ik}^2 + y_{il}^2}{2}\]
