...
```{r}
BarentsVEM<-VEMtree(counts = counts,MO = MO,SO = SO,ome_init = omega_init,W_init = W_init,Wg_init = Wg_init, eps=1e-2, alpha=1, maxIter=4, plot=TRUE,vraiOm = NULL, print.hist = FALSE)
