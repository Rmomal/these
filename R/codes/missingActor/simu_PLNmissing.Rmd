...
gener.data<-function(p=20,n=200,counts=FALSE, type="starerdos", v=0.001,plot=TRUE,prop=10/p){
  ...
  if(counts){
    ...
    data_obs=rmvnorm(n,sigma=sigma_obs)
...
We choose to initialize from sigma
