...
for(i in 1:N){
  names(simus[[i]])<-c("omega" ,"ZH"  , "VEM_1","time_boots", "nbinit"  )
...
saveRDS(simus, "/Users/raphaellemomal/these/R/codes/missingActor/SimResults/simus_14_14_filtre_sumP.rds")
simus=readRDS("/Users/raphaellemomal/these/R/codes/missingActor/SimResults/simus_14_14_filtre_sumP.rds")
