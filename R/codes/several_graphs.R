...
grid_arrange_shared_legend <- function(..., ncol = length(list(...)), nrow = 1, position = c("bottom", "right")) {
  ...
  auc_covcov<-readRDS("~/these/pack1/R/Simu/PLNcov/cluster/dens/auc.rds")
  auc_nocov<-readRDS("~/these/pack1/R/Simu/PLN/cluster/dens/auc.rds")
  ...
  p2 <-diagnostics("~/these/pack1/R/Simu/PLNcov/cluster/dens/auc.rds")
  p3 <-diagnostics("~/these/pack1/R/Simu/PLN/cluster/dens/auc.rds")
