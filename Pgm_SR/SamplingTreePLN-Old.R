...
# Parms
p = 10; 
B.path = 1e6; R.subsample = 1e3; B.path = 1e5; R.subsample = 5e2
# B.path = 1e4; R.subsample = 1e2
...
Y.sample = Y.sample[R.subsample*(1:floor(B.path/R.subsample)), ] # sample 1 out of R.subsample
