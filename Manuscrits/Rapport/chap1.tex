...
Transforming count data (for example log-transform) to use analysis tools from the Gaussian world is generally a bad idea \citep{OK10}. However in some cases, the data present with some constraint from the experiment setting, which need to be accounted for.
