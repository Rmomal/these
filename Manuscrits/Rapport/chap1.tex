...
%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 $$\log p_{\thetab} (\Ybf) = \Esp_\thetab [\log p_{\thetab} (\Ybf)\mid\Ybf] - \Esp_\thetab [\log p_{\thetab} (\Ybf) \mid \Ybf]. $$
