...
As we will see in the next section, it is possible to carry out network inference using average on trees, in which case  Theorem \ref{thmm:MTT} and Lemma \ref{lemm:Meila} are particularly useful.
...
\subsection{Network inference from Gaussian data}
 ...
 $$\ell_\lambda(\Omegab) =\log |\Omegab| - \tr ($$
