...
% Runing time
The resampling initialization procedure resulted in 14 different cliques, for each of which a VEM algorithm was run: the mean running time was $6.63$mins with deviation $0.70$ mins. 
