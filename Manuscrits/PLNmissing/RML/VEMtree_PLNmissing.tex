...
\mu_{H|O,T} &= \Sigma_{THO}\Sigma_{TO}^{-1}(Z_{Oi}-\underbrace{\mu_{Z_O|T}}_{0}) \\
...
Recalling $\mu_{H|Oi,T} = -\Omega_H^{-1}\Omega_{THO}Z_{Oi} ^T$ and that $\Omega_H$ is constrained to be diagonal and idenpendent of $T$ for identifiability, we have:
\begin{align*}
\log p(Z_H\mid Z_O,T) &= \frac{n}{2} \log |\Omega_H| -\frac{1}{2} \sum_i (Z_{Hi}-\mu_{H|Oi,T})\Omega_H(Z_{Hi}-\mu_{H|Oi,T})^T\\
&= \frac{n}{2} \log |\Omega_H| -\frac{1}{2} \sum_i \left(Z_{Hi}\Omega_HZ_{Hi}^T - \mu_{H|Oi,T}\Omega_H\mu_{H|Oi,T}^T \right)\\
&= \frac{n}{2} \log |\Omega_H| -\frac{1}{2}Tr(Z_H\Omega_HZ_H^T) - \frac{1}{2} Tr(Z_O\Omega_{THO}^T(\Omega_H^{-1})^T\Omega_{HO}Z_O^T)\\
&=\frac{n}{2} \log |\Omega_H| -\frac{1}{2}Tr(\Omega_HZ_H^TZ_H) - \frac{1}{2} Tr(\Omega_{THO}^T(\Omega_H^{-1})^T\Omega_{HO}Z_O^TZ_O)
\end{align*}

Now taking the expectation:

\begin{align*}
\Esp_{gh}[\log p(Z_H | Z_O,T) ] &= \frac{n}{2} \log |\Omega_H|-\frac{1}{2}Tr(\Omega_H \Esp_h[Z_H^TZ_H]) - \frac{1}{2} Tr(\Esp_g[\Omega_{THO}^T(\Omega_H^{-1})^T\Omega_{THO}]\Esp_h[Z_O^TZ_O])\\
&=\frac{n}{2} \log |\Omega_H| -\frac{1}{2}\left( <\Omega_H,\Esp_h[Z_H^TZ_H]> + <\Omega_H^{-1}\Esp_g[\Omega_{THO}^T\Omega_{THO}],\Esp_{h_O^*}[Z_O^TZ_O]> \right)
\end{align*}
