...
\subsection{Developped expressions}
\begin{align*}
...
\section*{Remarks}
\begin{itemize}
\item How to optimize in $m_H$ ? appears nowhere
\item $h_O$ is present as $S_O$ in the new terms, not all $h_O$ terms are taken care of by PLNmodels ?
\item in Genevieve article, formula (2.6) of $f_{ih}$ looks like our double-edge-proba problem
\item Edge  probabilities that appear are marginal, unlike before where they were conditional to data $Y$.
\end{itemize}
