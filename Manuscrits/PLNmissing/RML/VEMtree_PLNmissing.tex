...
\frac{\partial (-\Esp_{gh}[\log p(Z_H | Z_O,T) ])}{\partial M_H}&=  \Omega_H M_H + \widetilde{M}_O P_{gOH} \odot \Omega_{OH}\\
\frac{\partial (-\Esp_{gh}[\log p(Z_H | Z_O,T) ]) }{\partial s_{ih}}&= \omega_{hh}
\end{empheq}
...
\partial_{s_{ih}} (\Esp_h[\log h(Z_H\mid Z_O)])&= \frac{-1}{s_{ih}}
\end{empheq}
...
\Esp_g[\log |\Omega_{Tm}|]&= \sum _{kl} P_{gkl} \left[ \log\frac{\omega_{kk}\omega_{ll}-\omega_{kl}^2}{\omega_{kk}\omega_{ll}}\right]
\end{align*}

Finally we obtain:
\begin{align*}
 \Esp_{gh_O^*}[\log p(Z_O|T)] &= \frac{n}{2} \left(\sum _{kl} P_{gkl} \left[ \log\frac{\omega_{kk}\omega_{ll}-\omega_{kl}^2}{\omega_{kk}\omega_{ll}}\right]\right) - \frac{1}{2}< P_g \odot \Omega_O - \mathcal{C}_g, \widetilde{M}_O^T\widetilde{M}_O + \widetilde{S}_O> 
\end{align*}
