...
Denoting $\mathds{P}\{jk\in T \mid Y\}=P_{jk}$ we obtain:
\begin{empheq}[box=\lesswidefbox]{align*} 
  Q  &=  \sum_{j<k} P_{jk}\left( n \log \beta_{jk} + \frac{n}{2}\log\left( 1- \frac{\omega_{Tjk} ^2}{\omega_{Tjj}\omega_{Tkk}}\right)\right) -\log B  +\frac{n}{2}\sum_j \log(\omega_{Tjj})\\
  & \;\;\;\; - \frac{n}{2}\Esp\left[\Esp\left[ Tr(Z^T Z\Omega_T ) \,\middle\vert\,  Z_O,T\right] \,\middle\vert\,  Y\right]
\end{empheq}
