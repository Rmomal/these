...
\subsubsection{Details of  $\Esp_{gh}[\log p(\Zbf \mid T) ]$} 
 ...
 $$\Esp_{gh} [\log p(\Zbf \mid T)] = \frac{n}{2} \Esp_{gh} [\log | \Omega_T|] - \frac{1}{2} Tr(\Esp_g[\Omega_T] \Esp_h[\Zbf^\intercal \Zbf])$$
...
\begin{align*}
 \partial_{\omega_{kk}}\Esp_{gh} [\log (p_\beta(T)p_{\Omega_T}(\Zbf\mid T) ] &=  \partial_{\omega_{kk}} \Big( \sum_k (\log \omega_{kk} - \omega_{kk} \sigma_{kk} )+ \frac{1}{2} \sum_{k}\sum_{l\neq k} P_{jl} \log \big(1-\frac{\omega_{jl}^2}{\omega_{jj} \omega_{ll}}\big)\Big)\\
 &=   \frac{1}{\omega_{kk}} \Big( 1 + \frac{1}{2}\sum_{l\neq k} P_{kl} \omega_{kl} \frac{\omega_{kl}}{\omega_{kk}\omega_{ll} - \omega_{kl}^2}\Big) - \sigma_{kk} \\
  \end{align*}
 From the optimization of the off-diagonal terms, we have that $$\frac{\omega_{kl}}{(\omega_{kk}\omega_{ll}-\omega_{kl}^2)}  = - {\sigma}_{kl} $$
 which leads to
  $$\boxed{\hat{\omega}_{kk} = \frac{1}{\widetilde{\sigma}_{kk}} \left( 1- \frac{1}{2}\sum_{l\neq k}  P_{kl} \;\omega_{kl} \;\widetilde{\sigma}_{kl}\right)}$$
