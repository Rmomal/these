...
\end{align*}
 ...
 $$\log W_{kl} = \log(\varphi_{kl} \widetilde{\beta}_{kl}/\beta_{kl}) + \mathds{1}_{\{kl \in O^2\}} \frac{1}{2}\omega_{kl} [\widetilde{M}_O^\intercal \widetilde{M}_O]_{kl} + \mathds{1}_{\{ kl \in O\times H \}} \omega_{kl} [M_H^\intercal \widetilde{M}_O]_{kl} $$
 
Defining matrices A, B and C as follows:
\[\left\{\begin{array}{ll}
A_{kl} &= \varphi_{kl} \widetilde{\beta}_{kl}/\beta_{kl}\\
B_{kl} &=\exp(\frac{1}{2}\omega_{kl}[\widetilde{M}_O^\intercal \widetilde{M}_O]_{kl})\\
